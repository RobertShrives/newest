...
//        	boolean answser;
//        	boolean test;
//        	System.out.println(answser=ItemTable.getInstance().itemExists(strArray[0]));
//        	System.out.println(test=LoanTable.getInstance().checkLoan(strArray[0]));
//        	if((answser == true)&&(test == true)){
//        		output.setOutput("can't remove!");
//        	}else{
